<?php
    ...
    $data = mysqli_query($connection,"select * from cart where userId = ".$_SESSION['id']."");
?>
<html>
    <head>
    ...
    <body class="body">
        <div class="usercontainer">
            <label class="title">My Cart</label>
            <table>
                <thead>
                    <tr>
                        <th>Item Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        &&item=<?php echo $rows['itemId']?>&&price=<?php echo $rows['price']?>&&itemN=<?php echo $rows['itemName']?>
                        &&del=<?php echo $rows['id']?>">
