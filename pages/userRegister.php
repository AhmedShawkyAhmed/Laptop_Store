        ...
        <form method="POST" action="../api/insert.php" enctype="multipart/form-data">
                ...
                <table>
                    <tr>
                        ...
                        <td><input class="textinput" type="text" name="fname" required></td>
                    </tr>
                    <tr>
                        <td><label>Last Name</label></td>
                        <td><input class="textinput" type="text" name="lname" required></td>
                    </tr>
                    <tr>
                ...
                <br>
                <input class="submitinput" type="submit" value="Register" name="register">
            </form>
        </div>
    </body>
</html>